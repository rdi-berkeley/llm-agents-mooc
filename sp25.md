...
- The Fall 2024 iteration of the course can be found [here](https://llmagents-learning.org/f24).
...
|--------|-------|-------|
| Jan 27th | **Advanced prompting, overview of inference-time techniques for reasoning** <br> Xinyun Chen, Google DeepMind | |   
| Feb 3rd | **Learning to reason with LLMs** <br> Jason Weston, Meta | |   
| Feb 10th | **TBA**  | |   
