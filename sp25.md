...
| Feb 10th | **On Reasoning, Memory, and Planning of Language Agents** <br> Yu Su, Ohio State University <br> [Livestream](https://www.youtube.com/live/zvI4UN2_i-w) <a href="https://rdi.berkeley.edu/llm-agents-mooc/slides/language_agents_YuSu_Berkeley.pdf">Slides</a> | - [Grokked Transformers are Implicit Reasoners: A Mechanistic Journey to the Edge of Generalization](https://arxiv.org/abs/2405.15071) <br> - [HippoRAG: Neurobiologically Inspired Long-Term Memory for Large Language Models](https://arxiv.org/abs/2405.14831) <br> - [Is Your LLM Secretly a World Model of the Internet? Model-Based Planning for Web Agents](https://arxiv.org/abs/2411.06559) |   
