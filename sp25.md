...
There are two labs to give students experience with verificable code generation agents using Lean. Students must pass both labs, which are due at the end of May. Please ask any questions in our [LLM Agents Discord](https://discord.gg/NWVpQ9rBvd).
