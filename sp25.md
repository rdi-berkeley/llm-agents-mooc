...
- This course is built upon the fundamentals from the Fall 2024 LLM Agents MOOC, which can be found [here](https://llmagents-learning.org/f24).
...
Weekly lectures start on January 27th. Detailed syllabus to be announced. 
