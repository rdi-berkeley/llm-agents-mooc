...
| Dec 2 | **Towards Building Safe & Trustworthy AI Agents and A Path for Science‑ and Evidence‑based AI Policy** <br> Dawn Song, UC Berkeley <br> [Livestream](https://www.youtube.com/live/QAgR4uQ15rc) Slides posted soon. [Quiz 12](https://forms.gle/EHwL4Jb3LZzNDw7w7) | - [Decoding Trust: Comprehensive Assessment of Trustworthiness in GPT Models](https://decodingtrust.github.io/) <br> - [Extracting Training Data from Large Language Models](https://arxiv.org/abs/2012.07805) <br> - [Robust Physical-World Attacks on Deep Learning Models](https://arxiv.org/abs/1707.08945)  |  
