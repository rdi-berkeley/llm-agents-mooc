...
| Sept 16 | **LLM agents: brief history and overview** <br> Shunyu Yao, OpenAI <br> [Livestream](https://youtu.be/Ck66PiXXlFI?si=hCMrhS5mWNmEJnTJ) <a href="https://rdi.berkeley.edu/llm-agents-mooc/slides/llm_agent_history.pdf">Slides</a> | - [WebShop: Towards Scalable Real-World Web Interaction with Grounded Language Agents](https://arxiv.org/abs/2207.01206) <br> - [ReAct: Synergizing Reasoning and Acting in Language Models](https://arxiv.org/abs/2210.03629)  |          
